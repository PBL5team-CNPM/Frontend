...
const Film = (props) => {
    ...
    return(
        <Box 
            ...
            >
            <Heading transition='0.7s' style={style} fontSize='32px' ml='40px' mt='20px' bgColor='' color='white' pos='absolute' noOfLines={2} maxW='400px'>{props.data.title}</Heading>
            <Box ml='300px' mt='180px' pos='absolute'>
